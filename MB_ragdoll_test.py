...
rd_dict = {
            'head': [-22, 37, -45, 45, -30, 30, 'torso'],
            'neck': [-22, 37, -45, 45, -30, 30, ''],
            'clavicle_L': [-30, 30, 0, 0, -30, 10, ''],
            'clavicle_R': [-30, 30, 0, 0, -10, 30, ''],
            'torso': [-45, 68, -45, 45, -30, 30, 'pelvis'],
            'pelvis': [0, 0, 0, 0, 0, 0, ''],
            'spine01': [-45, 68, -45, 45, -30, 30,''],
            'spine02': [-45, 68, -45, 45, -30, 30,''],
            'spine03': [-45, 22, -45, 45, -30, 30, ''],
            'upperarm_L': [-98, 105, -1, 7, -60, 105, 'torso'],
            'upperarm_R': [-98, 105, -7, 1, -105, 60, 'torso'],
            'lowerarm_L': [-146, 0, 0, 15, 0, 0, 'upperarm_L'],
            'lowerarm_R': [-146, 0, 0, 15, 0, 0, 'upperarm_R'],
            #'hand_L': [-45, 45, -90, 86, -25, 36, 'lowerarm_L'],
            #'hand_R': [-45, 45, -86, 90, -36, 25, 'lowerarm_R'],
            'thigh_L': [-155, 45, -15, 15, -17, 88, 'pelvis'],
            'thigh_R': [-155, 45, -15, 15, -88, 17, 'pelvis'],
            'calf_L': [0, 150, 0, 0, 0, 0, 'thigh_L'],
            'calf_R': [0, 150, 0, 0, 0, 0, 'thigh_R'],
            'foot_L': [-44, 45, -26, 26, -15, 74, 'calf_L'],
            'foot_R': [-45, 44, -26, 26, -74, 15, 'calf_R']
            }
...
def mission():  
    ...
    for c in rd_dict:
        if not rd_dict[c][6]:
            ...
            obj[ext + c].rigid_body.mass = 720
    obj[ext + "pelvis"].rigid_body.mass = 720
    bpy.ops.object.select_all(action='DESELECT')
